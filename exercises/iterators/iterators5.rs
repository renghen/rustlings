...
fn count_iterator(map: &HashMap<String, Progress>, value: Progress) -> usize {
    ...
    // let filtered_values =  map.values().into_iter().filter(|progress| progress.to_owned() == value);
    // let filtered_values =  map.into_iter().filter(|&(_, v)| v.to_owned() == value);
    let filtered_values = map.values().into_iter().filter(|&&v| v == value);
